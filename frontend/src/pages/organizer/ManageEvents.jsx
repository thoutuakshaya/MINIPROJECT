...
function ManageEvents() {
  ...
  const fetchEvents = async () => {
    try {
      ...
      setToken(userToken);
      const res = await axios.get("https://https://miniproject-1asj.onrender.com/api/events/myevents", {
  ...
  const deleteEvent = async (eventId) => {
    ...
    try {
      await axios.delete(`https://https://miniproject-1asj.onrender.com/api/events/${eventId}`, {

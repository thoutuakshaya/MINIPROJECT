...
function OrganizerBookings() {
  ...
  const fetchBookings = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://https://miniproject-lasj.onrender.com/api/bookings/organizer", { headers });
  ...
  const handleCancel = async (bookingId) => {
    ...
    try {
      await axios.put(`https://https://miniproject-lasj.onrender.com/api/bookings/cancel/${bookingId}`, {}, { headers });

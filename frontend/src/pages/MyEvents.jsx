...
function MyEvents() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      try {
        const response = await axios.get('https://miniproject-1asj.onrender.com/api/events/myevents', {
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://miniproject-1asj.onrender.com/api/events/${id}`, {
